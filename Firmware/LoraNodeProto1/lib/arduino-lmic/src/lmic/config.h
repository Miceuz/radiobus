...
//#define DISABLE_PING
// define this in lmic_project_config.h to disable all code related to beacon
// tracking. Requires ping to be disabled too
//#define DISABLE_BEACONS

// define these in lmic_project_config.h to disable the corresponding MAC
// commands. Class A
...
//#define DISABLE_MCMD_DlChannelReq // set downlink channel for RX1 for given
// uplink channel. #define DISABLE_MCMD_RXTimingSetupReq // delay between TX and
// RX
// Class B
//#define DISABLE_MCMD_PingSlotChannelReq // set ping freq, automatically
// disabled by DISABLE_PING #define ENABLE_MCMD_BeaconTimingAns // next beacon
// start, DEPRECATED, normally disabled by DISABLE_BEACON

// DEPRECATED(tmm@mcci.com); replaced by LMIC.noRXIQinversion (dynamic). Don't
// define this.
...
// LMIC debugging for certification tests requires this, because debug prints
// affect timing too dramatically. But normal operation doesn't need this.
